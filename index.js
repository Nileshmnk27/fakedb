...
const payload = {
    iss: 'AG0f2RGlQKWej6Dwk3Y0qA',
    exp: ((new Date()).getTime() + 5000)
};
const token = jwt.sign(payload, 'NfPfcyjZe0Xmqa6vVRhp2o3q9x1RLJwwPufC');
...
app.post('/userinfo', (req, res) => {
  ...
  var options = {
    ...
    uri: "https://api.zoom.us/v2/meetings/676892536", 
    qs: {
        status: 'active' 
    },
    auth: {
...
rp(options)
    .then(function (response) {
      //printing the response on the console
        console.log('User has', JSON.stringify(response));
    ...
    .catch(function (err) {
        // API call failed...
        console.log('API call failed, reason ', JSON.stringify(err));
    });
